...
const translations = {
    ...
    "tr": {
        ...
        frc_desc: "#10043 Conscius Robotics'in mentoru olarak, öncelikle halkla ilişkiler ve sosyal medya üzerinde çalışırken, robotun montajı dahil olmak üzere yapılan çeşitli işlerde yardımcı oldum. Saint-Joseph Lisesinin resmi FRC takımı olarak, ilk sezonumuzda 2025 Marmara Bölgesel Finalisti ödülünü kazandık.",
    ...
    "fr": {
        ...
        frc_desc: "Étant mentor pour #10043 Conscius Robotics, tout en travaillant principalement sur les relations publiques et les réseaux sociaux, j'ai aidé dans une variété de travaux, y compris l'assemblage du robot lui-même. En tant qu'équipe FRC officielle du lycée Saint-Joseph, pendant notre première saison, nous avons remporté le prix de Finaliste à la Régionale de Marmara 2025.",
