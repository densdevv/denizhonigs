...
const translations = {
    "en": {
        ...
        frc_desc: "Being a mentor for #10043 Conscius Robotics, while primarily working on public relations and social media, I helped out in a variety of the work done, including the assembly of the robot itself. Conscius Robotics, the official FRC team of Saint-Joseph, is participating for the first time in 2025, during the REEFSCAPE season.",
    ...
    "tr": {
        ...
        experience: "🏢 Deneyim",
        extracurriculars: "💡 Okul Dışı Etkinlikler",
        intern: "Staj",
        software: "Yazılım",
        ...
        yillik_desc: "Saint-Joseph Lisesi 2025 mezunlarının birbirine yıllık yazısı yazabileceği online bir platform geliştirdik. Bu yazıların toplanıp yine bizler tarafından düzenlenmesini sağladık.",
        frc_desc: "#10043 Conscius Robotics'in mentoru olarak, öncelikle halkla ilişkiler ve sosyal medya üzerinde çalışırken, robotun montajı dahil olmak üzere yapılan çeşitli işlerde yardımcı oldum. Saint-Joseph'in resmi FRC takımı Conscius Robotics, 2025 yılında REEFSCAPE sezonunda ilk kez yarışıyor.",
    ...
    "fr": {
        ...
        yillik_desc: "Nous avons développé une plateforme en ligne où les diplômés de 2025 du Lycée Saint-Joseph peuvent écrire des notes de fin d'année les uns aux autres. Une fois collectées, les notes ont également été corrigées par nous.",
        frc_desc: "Étant mentor pour #10043 Conscius Robotics, tout en travaillant principalement sur les relations publiques et les réseaux sociaux, j'ai aidé dans une variété de travaux, y compris l'assemblage du robot lui-même. Conscius Robotics, l'équipe FRC officielle de Saint-Joseph, participe pour la première fois en 2025, pendant la saison REEFSCAPE.",
